...
'*************************************************************
'Return = WshShell.Run("cmd /C start /High flashplayer_18_sa.exe http://www.realmofthemadgod.com/AGCLoader" & xmlOutput & ".swf", 0, true)
Return = WshShell.Run("cmd /C start /High flashplayer_18_sa.exe https://realmofthemadgodhrd.appspot.com/AssembleeGameClient" & xmlOutput & ".swf", 0, true)
